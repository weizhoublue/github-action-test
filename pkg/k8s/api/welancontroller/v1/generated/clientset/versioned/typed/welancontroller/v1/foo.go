...
import (
	...
	scheme "github.com/weizhoublue/github-action-test/pkg/k8s/api/welancontroller/v1/generated/clientset/versioned/scheme"
...
func newFoos(c *WelanV1Client, namespace string) *foos {
	return &foos{
		client: c.RESTClient(),
		ns:     namespace,
	}

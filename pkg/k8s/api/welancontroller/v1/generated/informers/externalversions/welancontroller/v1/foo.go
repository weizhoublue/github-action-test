...
import (
	...
	versioned "github.com/weizhoublue/github-action-test/pkg/k8s/api/welancontroller/v1/generated/clientset/versioned"
	internalinterfaces "github.com/weizhoublue/github-action-test/pkg/k8s/api/welancontroller/v1/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/weizhoublue/github-action-test/pkg/k8s/api/welancontroller/v1/generated/listers/welancontroller/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.WelanV1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WelanV1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&welancontrollerv1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&welancontrollerv1.Foo{}, f.defaultInformer)
}
